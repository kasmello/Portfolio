  ...
  return (
    <div>
      <div className='Header'>
        <h1 style={{marginLeft: '4vw', paddingTop: '10vh', fontFamily: 'EB Garamond, serif',fontSize: '5em'}}>Joannes Karmel Gandahusada</h1>
        <h3 style={{marginLeft: '6vw', marginTop: '-5vh', paddingBottom: '2vh', fontFamily: 'EB Garamond, serif',fontSize: '1em'}}>Data Scientist/Fullstack Developer/AI Engineer</h3>
      </div>
      <div className='Background-theme'>
        <p style={{marginLeft: '4vw', paddingTop: '3vh'}}>Since 2019, I have been dedicated to studying and advancing my skills in AI and data science. My journey has been marked by a commitment to continuous learning, and exploring the latest advancements in these fields. In 2021, I started working professionally and have loved it ever since, successfully leveraging my expertise to real-world applications.</p>
